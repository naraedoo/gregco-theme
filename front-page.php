...
?>
  <div class="spacer up-on-scroll" style="height:auto;"><p>Design and engineering to impact people, society and the planet. At Elisava we train designers with a creative profile, critical thinking and an exploratory vision of the world, capable of questioning and conversing with other people in the social, productive, scientific or cultural environment. Our students will be trained to design products, services and environments that foster a more inclusive and sustainable society.</p></div>
  <div class="line_greg"></div>
  <aside class="subtitle">
...
$title   = get_the_title();
$date    = get_the_date();
$tags    = get_the_tag_list('<ul class="tagging"><li>', '</li><li>', '</li></ul>');
$excerpt = get_the_excerpt();
$image   = get_the_post_thumbnail_url(get_the_ID(), 'full');
$link    = get_permalink();

// ✅ 여기부터 출력
echo "<div class='post-row up-on-scroll" . ($is_last_post ? " last-post" : "") . "'>";
  ...
  if ($image) {
    echo "<div class='ima'><img src='$image' alt='$title' class='featured-image' style='display: none;'></div>";
  }
